...
Proto.Model.addCycleCallback = function(self,cb)
    return self:_addCycleCallback(function(model) return cb(Proto.Model:_wrap(model)) end, nil)
end
...
Proto.Core.addStepCallback = function(self,cb)
    return self:_addStepCallback(function(core) return cb(Proto.Core:_wrap(core)) end, nil)
end
